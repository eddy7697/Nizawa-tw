...
<head>
  ...
  <meta charset="utf-8">
  <title>CyberHolic Page builder</title>
        ...
        <ul class="nav nav-list accordion-group">
          ...
          <li class="boxes" id="elmBase">
            <div class="box box-element ui-draggable">
              ...
              <div class="view">
                <h3 class="contenteditable" contenteditable="true">h3. 这是一套可视化布局系统.</h3>
              </div>
            </div>
            <div class="box box-element ui-draggable">
              <a href="#close" class="remove label label-danger">
            ...
            <div class="box box-element ui-draggable">
              ...
              <div class="view">
                <address class="contenteditable" contenteditable="true"><strong>Twitter, Inc.</strong>
                  <br>
            ...
            <div class="box box-element ui-draggable">
              ...
              <div class="view clearfix">
                <blockquote class="contenteditable" contenteditable="true">
                  <p>
            ...
            <div class="box box-element ui-draggable">
              ...
              <div class="view">
                <ul class="contenteditable" contenteditable="true">
            ...
            <div class="box box-element ui-draggable">
              ...
              <div class="view">
                <ol class="contenteditable" contenteditable="true">
                  <li>Lorem ipsum dolor sit amet</li>
                  <li>Consectetur adipiscing elit</li>
                  <li>Integer molestie lorem at massa</li>
                  <li>Facilisis in pretium nisl aliquet</li>
            ...
            <div class="box box-element ui-draggable">
              ...
              <div class="view">
                <dl class="contenteditable" contenteditable="true">
            ...
            <div class="box box-element ui-draggable">
              ...
              <div class="view">
                <table class="table contenteditable" contenteditable="true">
                  <thead>
                  <tr>
                    <th>编号</th>
                    <th>产品</th>
            ...
            <div class="box box-element ui-draggable">
              ...
              <div class="view">
                <button type="button" class="btn btn-default contenteditable" contenteditable="true">按钮</button>
              </div>
            </div>
            <div class="box box-element ui-draggable">
              <a href="#close" class="remove label label-danger">
        ...
        <ul class="nav nav-list accordion-group">
          ...
          <li class="boxes" id="elmComponents">
            ...
            <div class="box box-element ui-draggable">
              ...
              <div class="view">
                <div class="btn-group">
                  <button class="btn btn-default contenteditable" contenteditable="true">Action</button>
                  <button data-toggle="dropdown" class="btn btn-default dropdown-toggle">
                    <span class="caret"></span>
                  </button>
                  <ul class="dropdown-menu contenteditable" contenteditable="true">
                    <li>
                      <a href="#">操作</a>
                    </li>
                    <li class="disabled">
            ...
            <div class="box box-element ui-draggable">
              ...
              <div class="view">
                <ul class="nav nav-tabs contenteditable" contenteditable="true">
                  <li class="active">
                    <a href="#">首页</a>
                  </li>
                  <li>
            ...
            <div class="box box-element ui-draggable">
              ...
              <div class="view">
                ...
                <ul class="breadcrumb">
                  <li>
                    <a href="#" class="contenteditable" contenteditable="true">Home</a>
                  </li>
                  <li>
                    <a href="#" class="contenteditable" contenteditable="true">Library</a>
                  </li>
                  <li class="active contenteditable" contenteditable="true">Data</li>
                </ul>
            ...
            <div class="box box-element ui-draggable">
              ...
              <div class="view">
                <ul class="pagination contenteditable" contenteditable="true">
                  <li>
                    <a href="#">Prev</a>
                  </li>
                  <li>
            ...
            <div class="box box-element ui-draggable">
              ...
              <div class="view">
                <span class="label label-default contenteditable" contenteditable="true">标签</span>
              </div>
            </div>
            <div class="box box-element ui-draggable">
              <a href="#close" class="remove label label-danger">
              ...
              <div class="view">
                <ul class="nav nav-pills contenteditable" contenteditable="true">
                  <li class="active">
                    <a href="#">
            ...
            <div class="box box-element ui-draggable">
              ...
              <div class="view">
                <div class="jumbotron contenteditable" contenteditable="true">
                  <h1>Hello, world!</h1>
            ...
            <div class="box box-element ui-draggable">
              ...
              <div class="view">
                <div class="page-header">
                  <h1 class="contenteditable" contenteditable="true">
                    Example page header
            ...
            <div class="box box-element ui-draggable">
              ...
              <div class="view">
                <h2 class="contenteditable" contenteditable="true">Heading</h2>

                <p class="contenteditable" contenteditable="true">
                ...
                <p>
                  <a class="btn contenteditable" href="#" contenteditable="true">View details »</a>
                </p>
              </div>
            </div>
            <div class="box box-element ui-draggable">
            ...
            <div class="box box-element ui-draggable">
              ...
              <div class="view">
                <div class="list-group contenteditable" contenteditable="true">
              ...
              <div class="view">
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h3 class="panel-title contenteditable" contenteditable="true">Panel title</h3>
                  </div>
                  <div class="panel-body contenteditable" contenteditable="true">Panel content</div>
                  <div class="panel-footer contenteditable" contenteditable="true">Panel footer</div>
                </div>
              </div>
            </div>
        ...
        <ul class="nav nav-list accordion-group">
          ...
          <li class="boxes mute" id="elmJS">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title contenteditable" id="myModalLabel" contenteditable="true">标题</h4>
                      </div>
                      <div class="modal-body contenteditable" contenteditable="true">内容...</div>
                      <div class="modal-footer">
                        <button type="button" class="btn btn-default contenteditable" data-dismiss="modal" contenteditable="true">关闭
                        </button>
                        <button type="button" class="btn btn-primary contenteditable" contenteditable="true">保存</button>
                      </div>
                    </div>
                    <!-- /.modal-content -->
                  </div>
              ...
              <div class="view">
                <div class="tabbable" id="myTabs">
                  ...
                  <ul class="nav nav-tabs">
                    <li class="active">
                      <a href="#tab1" data-toggle="tab" class="contenteditable" contenteditable="true">Section 1</a>
                    </li>
                    <li>
                      <a href="#tab2" data-toggle="tab" class="contenteditable" contenteditable="true">Section 2</a>
                    </li>
                  </ul>
                  <div class="tab-content">
                    <div class="tab-pane active" id="tab1">
                      <p class="contenteditable" contenteditable="true">I'm in Section 1.</p>
                    </div>
                    <div class="tab-pane" id="tab2">
                      <p class="contenteditable" contenteditable="true">Howdy, I'm in Section 2.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="box box-element ui-draggable">
              ...
              <div class="view">
                <div class="alert alert-success alert-dismissable contenteditable" contenteditable="true">
            ...
            <div class="box box-element ui-draggable">
              ...
              <div class="view">
                <div class="panel-group" id="myAccordion">
                  <div class="panel panel-default">
                    <div class="panel-heading">
                      <a class="panel-title contenteditable" data-toggle="collapse" data-parent="#myAccordion" href="#collapseOne"
                         contenteditable="true">Collapsible Group Item #1</a>
                    </div>
                    <div id="collapseOne" class="panel-collapse collapse in">
                      <div class="panel-body contenteditable" contenteditable="true">Anim pariatur cliche...</div>
                    </div>
                  </div>
                  <div class="panel panel-default">
                    <div class="panel-heading">
                      <a class="panel-title contenteditable" data-toggle="collapse" data-parent="#myAccordion" href="#collapseTwo"
          ...
          <div class="row clearfix">
            <div class="col-md-12 column ui-sortable">
              ...
              <div class="box box-element">
                ...
                <div class="view">
                  <div class="jumbotron well contenteditable" contenteditable="true">
                    <h1>Hello, world!</h1>
