...
@section('custom-script')
    ...
    <script type="text/javascript">
        $(function () {
            $('.title_user').css('border-bottom','solid 3px #616161')
        });
    </script>
@endsection
                    ...
                    <table class="sign-form">
                        ...
                        <tr>
                            <td style="padding: 5px;">
                                <button type="submit" class="btn btn-primary" name="button" style="background-color: #0C6BB0">登入</button>
                        ...
                        <tr>
                            <td>
                                <a href="{{ url('/forget-password') }}" style="color: #0C6BB0">忘記您的密碼？</a>&nbsp;|&nbsp;
                                <a href="{{ url('/register') }}" style="color: #0C6BB0">點我註冊</a>
                            </td>
                        </tr>
                    </table>
                </form>
                    ...
                    <div id="home" class="tab-pane fade in active">
                        <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                            ...
                            <table class="sign-form">
                                ...
                                <tr>
                                    <td style="padding: 5px;">
                                        <button type="submit" class="btn btn-primary" name="button">登入</button>
                                        <a class="btn btn-primary" href="{{ url('auth/facebook') }}" style="background:#3B5998; border:#3B5998; font-size: 16px">
                                            <i class="fa fa-facebook"></i>&nbsp;&nbsp;Facebook 登入
                                        </a>
                                        <input type="checkbox" id="remamber" name="remamber" value="">
