...
<div class="tab-content">
    <div class="tab-pane active" id="home">
        <div class="container">
            <div class="col-md-12 industry-container">
                <img class="flow-image" src="https://nizawa.shuo-guo.net/img/industry/drinking_water.jpg" alt="">
            </div>
        </div>
    ...
    <div class="tab-pane fade" id="menu1">
        <div class="container">
            <div class="col-md-12 industry-container">
                <img class="flow-image" src="https://nizawa.shuo-guo.net/img/industry/pure_water.jpg" alt="">
            </div>
        </div>
        <section class="industry-map">
            <div class="container">
