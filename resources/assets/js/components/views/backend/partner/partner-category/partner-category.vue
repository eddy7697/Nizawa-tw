            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success" @click="editCategory(editCategoryForm)">儲存分類</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        methods: {
            addCategory: function () {
                ...
                .done(function(result) {
                    self.showMessage('success', '新增分類成功');
                    self.addCategoryForm.parentId = null;
            ...
            editCategory: function (item) {
                ...
                .done(function(result) {
                    self.getCategories();
                    self.showMessage('success', '分類編輯成功');
                    $('#myModal').modal('hide');
                })
            ...
            deleteCategory: function (item) {
                var self = this;
                var token = this.token;
                var checkProperty = confirm("是否刪除分類?");
                ...
                if (checkProperty) {
                    ...
                    .done(function(result) {
                        self.showMessage('success', '刪除分類成功');
                    })
                    .fail(function(errorData) {
                        self.showMessage('error', '刪除分類失敗');
                    })
                    .always(function() {
                        self.getCategories();
                    });
